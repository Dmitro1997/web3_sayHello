...
/* harmony import */ var _abis_HelloWorld_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(290);
...
const loadBlockchainData = async (web3Info) => {
  if (web3Info) {
    ...
    if (accounts.length > 0) {
      ...
      const networkData = _abis_HelloWorld_json__WEBPACK_IMPORTED_MODULE_0__.networks[networkId]
      if (networkData) {
        const abi = _abis_HelloWorld_json__WEBPACK_IMPORTED_MODULE_0__.abi
